...
import { AsyncThinkingServer, ThoughtInput } from '../src/lib/thinking.js';
...
describe('AsyncThinkingServer', () => {
  ...
  describe('processThought - with logging enabled', () => {
    let serverWithLogging: AsyncThinkingServer;

    beforeEach(() => {
      // Enable thought logging for these tests
      delete process.env.DISABLE_THOUGHT_LOGGING;
      serverWithLogging = new AsyncThinkingServer();
    });
