...
export const PHASE_0_NOTICE =
  'v2 refactor in progress on this branch. Pin to the v1.1.9 git tag for stable behavior.';

export function stubResponse(toolName: string) {
  const payload = {
